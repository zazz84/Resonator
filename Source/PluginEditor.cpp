...
//==============================================================================
ResonatorAudioProcessorEditor::ResonatorAudioProcessorEditor (ResonatorAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{
	...
	for (int i = 0; i < N_SLIDERS_COUNT; i++)
	{
		...
		//Lable
		label.setText(ResonatorAudioProcessor::paramsNames[i], juce::dontSendNotification);
		...
		m_sliderAttachment[i].reset(new SliderAttachment(valueTreeState, ResonatorAudioProcessor::paramsNames[i], slider));
	}
